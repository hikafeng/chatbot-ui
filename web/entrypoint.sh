...
export SUPABASE_SERVER_URL=${SUPABASE_SERVER_URL:-"http://kong:8000"}
export NEXT_PUBLIC_SUPABASE_SERVER_URL=${NEXT_PUBLIC_SUPABASE_SERVER_URL:-$SUPABASE_SERVER_URL}
export NEXT_PUBLIC_SUPABASE_PUBLIC_URL=${NEXT_PUBLIC_SUPABASE_PUBLIC_URL:-"/api/supabase"}
